...
def draw_hash_ring():
    ...
    # Giả sử Key "my_key" băm ra góc 150 độ (nằm giữa Node 8000 và Node 8001)
    key_angle = 155
    ...
    # Vẽ mũi tên hướng clockwise chiều băm
    # Mũi tên từ Key (150 độ) đến Node 8001 (210 độ)
